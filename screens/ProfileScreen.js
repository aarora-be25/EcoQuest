...
export default function ProfileScreen({ navigate }) {
  const handleLogout = () => {
    Alert.alert('Log out', 'Are you sure you want to log out?', [
      ...
      { text: 'Log out', style: 'destructive', onPress: () => navigate('home') },
    ]);
  };
      ...
      <ScrollView style={styles.body} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.profileCard}>
          ...
          <View style={styles.tagRow}>
            <View style={styles.tag}><Text style={styles.tagText}>{CURRENT_USER.branch}</Text></View>
            <View style={styles.tag}><Text style={styles.tagText}>{CURRENT_USER.year} year</Text></View>
            <View style={styles.tag}><Text style={styles.tagText}>Section {CURRENT_USER.section}</Text></View>
          </View>
        </View>
        ...
        {COMPLETED.length === 0 ? (
          <View style={styles.emptyCard}>
            ...
            <Text style={styles.emptyText}>No completed tasks yet. Start your eco journey!</Text>
          </View>
        ) : (
          <View style={styles.completedCard}>
            {COMPLETED.map((t, i) => (
              <View key={t.id} style={[styles.completedRow, i === COMPLETED.length - 1 && { borderBottomWidth: 0 }]}>
        ...
        <View style={styles.achieveGrid}>
          {ACHIEVEMENTS.map((a, i) => (
            <View key={i} style={[styles.achieveCard, !a.unlocked && styles.achieveLocked]}>
              <Text style={{ fontSize: 28, opacity: a.unlocked ? 1 : 0.3 }}>{a.icon}</Text>
              <Text style={[styles.achieveLabel, !a.unlocked && styles.achieveTextLocked]}>{a.label}</Text>
              <Text style={[styles.achieveDesc, !a.unlocked && styles.achieveTextLocked]}>{a.desc}</Text>
        ...
        <View style={styles.settingsCard}>
          {[
            ...
            { label: 'Notifications', icon: '🔔', onPress: () => navigate('notifications') },
...
const styles = StyleSheet.create({
  ...
  completedName: { flex: 1, fontSize: 13, color: COLORS.textPrimary, fontWeight: FONTS.medium },
  completedPts: { fontSize: 13, fontWeight: FONTS.heavy, color: COLORS.accent },
  completedCheck: { fontSize: 14, color: COLORS.primary, fontWeight: FONTS.heavy },
  ...
  achieveLocked: { backgroundColor: COLORS.bgPage, borderColor: COLORS.border },
  ...
  logoutBtn: {
    ...
    borderColor: COLORS.danger, padding: SPACING.base,
      ...
      >
        ...
        <View style={styles.profileCard}>
          ...
          <View style={styles.tagRow}>
            ...
            <View style={styles.tag}>
              <Text style={styles.tagText}>{CURRENT_USER.year} year</Text>
            </View>
            <View style={styles.tag}>
